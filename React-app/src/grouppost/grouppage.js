...
function PostItem(props) {
  const { id, timestemp, postdes, name_createpost, comment_des,img } = props;
  ...
  return (
    <div className="post-item">
      <div className="img-contrainer">
        <img src={img} alt="img-show" className="img-post" />
      </div>
      ...
      <div className="content-post">{postdes}</div>
          ...
          <Fade in={open2}>
            <Box className="modal-new-post">
              ...
              <div className="form-in-newpost">
                ...
                <div className="button-con2">
                  <button
                    className="button-summit-newpost"
                    onClick={createPost}
                  >
                    <h2 style={{ margin: 0, fontWeight: 300, color: "white" }}>
                      New Post
