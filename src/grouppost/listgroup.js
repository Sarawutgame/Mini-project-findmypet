...
function CardGroup(props){
    ...
    return(
        <div className='card-g'>
            ...
            <h3 style={{fontSize:'24px', margin:'10px', textOverflow:'ellipsis', overflow:'hidden', whiteSpace:'nowrap'}}>{name_group}</h3>
            <h4 style={{margin:'5px', marginLeft:'10px'}}>About Group</h4>
            <p style={{fontSize:'16px', margin:'10px',marginTop:'5px', textOverflow:'ellipsis', overflow:'hidden', whiteSpace:'nowrap'}}>{descript}</p>
            <h4 style={{fontSize:'16px', margin:'10px',marginTop:'5px', textOverflow:'ellipsis', overflow:'hidden', whiteSpace:'nowrap'}}>{name_create}</h4>
        ...
        <div>
            ...
            <Box className='modal-create-group'>
                    <div className='modal-head'>
                        <h1 style={{marginBottom:'0', marginLeft:"0"}}>สร้างกลุ่มใหม่</h1>
                        <hr className='line2'/>
                    </div>
                    <div className='form-in'>
                        <form>
                            <div style={{marginBottom:'2%'}}>
                                ...
                                <input type='text' placeholder="Ex. เเมวเมียวๆ" style={{width:'50%', height:'40px', borderRadius:'20px',padding:'2%'}}/>
                            </div>
                            <div style={{marginBottom:'2%'}}>
                        ...
                        <div className='button-con2'>
                            <button className='button-summit-newgroup' onClick={handleClose}>
                                <h2 style={{margin: 0, fontWeight:300, color:'white'}}>Create Group</h2>
                            </button>
                        </div>
                    </div>
                </Box>
